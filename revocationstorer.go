...
// revocationID does not have to be the token's id or sid even
// you can just use the signature if you want
func (urs *UnimplementedRevocationStorer) Revoke(ctx context.Context, revocationID string) error {
	return ErrUnimplemented
}

// CheckRevocation checks the store to see if the token has been revoked
func (urs *UnimplementedRevocationStorer) CheckRevocation(ctx context.Context, revocatonID string) error {
	return ErrUnimplemented
}
